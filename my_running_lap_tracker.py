...
print("Time Complexity: O(1), and Space Complexity: O(1)")
print()
...
print("Total Running Points:", loop_total, "Steps Taken:", steps_loop)
print("Time Complexity: O(n) and Space Complexity: O(1)")
print()
...
print("Total Running Points:", nested_total, "Steps Taken:", steps_nested)
print("Time Complexity: O(n^2) and Space Complexity: O(1)")
print()


print("ALGORITHM EFFICIENCY COMPARISON")

print("Formula Method: Fastest because it takes only 1 calculation.")
