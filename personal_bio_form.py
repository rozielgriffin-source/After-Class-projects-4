...
title_label = Label(
    form_frame, text="Personal Bio Form", font= ("Arial", 18, "bold"), fg="white", bg="black", width=25)
title_label.grid(row=0, column=0, columnspan=2, pady=10)
 
name_label = Label(form_frame, text="Name:", bg="white", font=("Arial", 12))
name_label.grid(row=1, column=0, sticky="w", pady=5)
 
age_label = Label(form_frame, text="Age:", bg="white", font=("Arial", 12))
age_label.grid(row=2, column=0, sticky="w", pady=5)
 
hobby_label = Label(form_frame, text="Hobby:", bg="white", font=("Arial", 12))
hobby_label.grid(row=3, column=0, sticky="w", pady=5)
 
about_label = Label(form_frame, text="Extra Info:", bg="white", font=("Arial", 12))
...
hobby_entry = Entry(form_frame, width=25)
...
result_label = Label(
    form_frame, text="Your bio will appear here.", bg="green", fg="white", width=35, height=5, wraplength=300, justify="left")
